...
-- 上で挿入した同じ語源の id を使って単語を挿入（1件だけサンプル）
...
-- 使い方メモ
-- =============================================================================
-- 【word_groups】 同じ語源単位の穴埋め・○×・派生語リスト（Hirono 学習ページ用）
-- 【words】      同じ語源に属する単語。examples=穴埋め、example_sentence_*=代表例文、synonyms=同義語
